...
- Ficha com **17 critérios** avaliados em escala **0 / 1 / 2** (não fez, fez em parte, fez)
...
|---|---|---|
| A | Usabilidade — 10 heurísticas de Nielsen | 60 |
| B | Uso do Figma — componentes, estilos, Auto Layout, protótipo | 25 |
| C | Entrega — seções obrigatórias, versão mobile, prazo | 15 |
